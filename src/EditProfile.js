    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-4xl px-8 flex items-center justify-between mb-8">
        ...
        <div className="flex items-center">
          <img className="w-10 h-10 rounded-full mr-2" src="/path_to_your_image.jpg" alt="User Profile" />
          <div className="flex items-center">
        ...
        <form className="space-y-6">
          ...
          <div className="border-t border-gray-200 pt-4 space-y-4">
            ...
            <div className="border p-4 rounded">
              ...
              <img src="/path_to_your_image.jpg" alt="Profile" className="mt-2 w-20 h-20 rounded-full" />
            </div>
